  ...
  '2': [ // Low carb
    {
      ...
      time: '8:00 AM',
      calories: 420,
      image: 'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=150&fit=crop',
    ...
    },
    {
      ...
      ingredients: ['chicken breast', 'mixed greens', 'cucumber', 'olive oil dressing'],
    },
    {
      id: '3',
...
const DietCard: React.FC<{ diet: DietOption; onPress: () => void }> = ({
  ...
  <Card style={[styles.card, { backgroundColor: diet.color }]} onPress={onPress}>
    <View style={styles.cardContent}>
      <View style={styles.cardText}>
        <View style={styles.cardHeader}>
          <Title style={styles.cardTitle}>{diet.title}</Title>
        ...
        <Paragraph style={styles.cardDescription}>{diet.description}</Paragraph>
      ...
      <View style={styles.mealInfo}>
        ...
        <View style={styles.ingredients}>
          {meal.ingredients.slice(0, 3).map((ingredient, index) => (
            <Chip key={index} style={styles.ingredientChip} textStyle={styles.chipText}>
              {ingredient}
            </Chip>
          ))}
          {meal.ingredients.length > 3 && (
            <Text style={styles.moreIngredients}>+{meal.ingredients.length - 3} more</Text>
          )}
        </View>
      </View>
    </View>
...
const DietDetailScreen: React.FC<{
  ...
  const getGoalIcon = () => {
    if (diet.goal === 'muscle_gain') return <TrendingUp size={24} color="#4CAF50" />;
    if (diet.goal === 'weight_loss') return <TrendingDown size={24} color="#FF5722" />;
    ...
    <ScrollView style={styles.detailContainer} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.detailContent}>
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statCard}>
            <Text style={[styles.statValue, { color: getDifficultyColor(diet.difficulty) }]}>
              {diet.difficulty}
            </Text>
          ...
          <View style={styles.mealsSection}>
            <View style={styles.mealsSectionHeader}>
              ...
              <View style={styles.totalCalories}>
                ...
                <Text style={styles.totalCaloriesText}>{totalCalories} cal/day</Text>
              </View>
            </View>
            ...
            {diet.goal === 'muscle_gain' && (
              <>
                <View style={styles.benefitItem}>
                  ...
                  <Text style={styles.benefitText}>Promotes muscle protein synthesis</Text>
                </View>
                <View style={styles.benefitItem}>
                  <Target size={16} color="#4CAF50" />
                  <Text style={styles.benefitText}>Optimized for strength training</Text>
                </View>
                <View style={styles.benefitItem}>
                  <Apple size={16} color="#4CAF50" />
                  <Text style={styles.benefitText}>High-quality protein sources</Text>
                </View>
              </>
            )}
            {diet.goal === 'weight_loss' && (
              <>
                ...
                <View style={styles.benefitItem}>
                  ...
                  <Text style={styles.benefitText}>Reduces appetite naturally</Text>
                </View>
              </>
            )}
            {diet.goal === 'balanced' && (
              <>
                <View style={styles.benefitItem}>
                  ...
                  <Text style={styles.benefitText}>Balanced nutrition approach</Text>
                </View>
                <View style={styles.benefitItem}>
                ...
                <View style={styles.benefitItem}>
                  ...
                  <Text style={styles.benefitText}>Suitable for most people</Text>
                </View>
              </>
            )}
          </View>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            <Title style={styles.headerTitle}>Diet Plans</Title>
            <Paragraph style={styles.headerSubtitle}>
              Choose the perfect diet plan for your fitness goals
            </Paragraph>
          </View>

          <View style={styles.goalFilters}>
            <Chip icon={() => <Target size={16} color="#4CAF50" />} style={styles.filterChip}>
              All Goals
            </Chip>
            <Chip icon={() => <TrendingUp size={16} color="#4CAF50" />} style={styles.filterChip}>
              Muscle Gain
            </Chip>
            <Chip icon={() => <TrendingDown size={16} color="#FF5722" />} style={styles.filterChip}>
              Weight Loss
            </Chip>
          </View>
